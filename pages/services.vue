...
div(class="w-full flex px-10 h-auto  relative overflow-visible")
    div(class="w-[30%] flex flex-wrap justify-center md:justify-between gap-y-[2.6rem] mt-[3rem] px-8 ")
        ...
        Service(@select="selectMenu" title="KITCHEN CLEANING" :selected="selected" desc="We clean and care  for variety of hard surface flooring at many places of business." image="icons/icon_13.png")
        Service(@select="selectMenu"  title="FLOOR CLEANING" :selected="selected" desc="We clean and care  for variety of hard surface flooring at many places of business." image="icons/icon_23.png")
        Service(@select="selectMenu"  title="BATHROOM CLEANING" :selected="selected" desc="We clean and care  for variety of hard surface flooring at many places of business." image="icons/icon_33.png")
        Service(@select="selectMenu"  title="OFFICE CLEANING" :selected="selected" desc="We clean and care  for variety of hard surface flooring at many places of business." image="icons/icon_43.png")
        Service(@select="selectMenu"  title="CAR CLEANING" :selected="selected" desc="We clean and care  for variety of hard surface flooring at many places of business." image="icons/icon_53.png")
        Service(@select="selectMenu"  title="WINDOW CLEANING" :selected="selected" desc="We clean and care  for variety of hard surface flooring at many places of business." image="icons/icon_13.png")
        Service(@select="selectMenu"  title="POWER WASHING" :selected="selected" desc="We clean and care  for variety of hard surface flooring at many places of business." image="icons/icon_13.png")
        Service(@select="selectMenu"  title="UPHOLSTERY CLEANING" :selected="selected" desc="We clean and care  for variety of hard surface flooring at many places of business." image="icons/icon_13.png")
        Service(@select="selectMenu"  title="GARDEN MAINTENANCE" :selected="selected" desc="We clean and care  for variety of hard surface flooring at many places of business." image="icons/icon_13.png")

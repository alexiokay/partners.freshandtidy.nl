...
import { useSSRContext, defineComponent, mergeProps, withCtx, createTextVNode, ref } from 'vue';
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/Login/CarrierRegisterForm.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_LoginCarrierRegisterForm = _sfc_main$1;
      ...
      _push(ssrRenderComponent(_component_LoginCarrierRegisterForm, null, null, _parent));
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/signup/carrier.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=carrier-96a933e7.mjs.map
